...
try
{
    ...
    logger.Info($"Variables loaded in program.cs: Secret: {vaultSecrets.dictionary["Secret"]}, Issuer: {vaultSecrets.dictionary["Issuer"]}, ConnectionURI : {vaultSecrets.dictionary["Issuer"]}, Salt: {vaultSecrets.dictionary["Salt"]}");
